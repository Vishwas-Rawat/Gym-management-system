...
public class GymController {
    ...
    public List<GymRegisterResponse> createGyms(@RequestBody List<Gym> gyms, Authentication authentication) {
        ...
        User admin = userRepository.findByEmail(identity)
    ...
    public GymRegisterResponse updateGym(@PathVariable Long gymId, @RequestBody Gym updatedGym, Authentication authentication) {
        String identity = authentication.getName(); // this is email from JWT
